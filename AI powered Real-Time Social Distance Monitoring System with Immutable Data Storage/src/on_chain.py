...
# infura = "https://mainnet.infura.io/v3/dfc289b338864af1ba670abb53f30679"
# can make the calls either using ganache or using infura ---> just change provider=infura
...
class OnChain:
    ...
    def store_hash(self, event_id, location, time, violations):
        ...
        outF = open("C:/Users/vatsa/Desktop/Major Project/AI powered Real-Time Social Distance Monitoring System with Immutable Data Storage/events.txt", "a")
        outF.write(str(event_id))
        outF.write("\t")
        outF.write(str(event_hash))
        outF.write("\n")
